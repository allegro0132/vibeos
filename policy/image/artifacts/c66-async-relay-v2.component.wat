(component
  ...
  ;; C6.6 deliberately changes the inert implementation identity while keeping
  ;; the exact C6.5 relay world and interface. Profile 1 async cannot execute it.
  (core func $task-return
    (canon task.return (result $out-byte-stream)))
  (core instance $builtins
    (export "task-return" (func $task-return)))
  (core module $relay-v2
    ...
    (func (export "callback") (param i32 i32 i32) (result i32)
      i32.const 0))
  (core instance $relay-v2-instance
    (instantiate $relay-v2
      (with "test:c65-validation" (instance $builtins))))
  (alias core export $relay-v2-instance "run" (core func $run))
  (alias core export $relay-v2-instance "callback" (core func $callback))
