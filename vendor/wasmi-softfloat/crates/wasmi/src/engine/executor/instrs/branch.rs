...
fn cmp_f32_eq(a: f32, b: f32) -> bool {
    wasmi_core::softfloat::f32_eq_bits(a.to_bits(), b.to_bits())
}

fn cmp_f32_ne(a: f32, b: f32) -> bool {
    wasmi_core::softfloat::f32_ne_bits(a.to_bits(), b.to_bits())
}

fn cmp_f32_lt(a: f32, b: f32) -> bool {
    wasmi_core::softfloat::f32_lt_bits(a.to_bits(), b.to_bits())
}

fn cmp_f32_le(a: f32, b: f32) -> bool {
    wasmi_core::softfloat::f32_le_bits(a.to_bits(), b.to_bits())
}

fn cmp_f32_not_lt(a: f32, b: f32) -> bool {
    !cmp_f32_lt(a, b)
}

fn cmp_f32_not_le(a: f32, b: f32) -> bool {
    !cmp_f32_le(a, b)
}

fn cmp_f64_eq(a: f64, b: f64) -> bool {
    wasmi_core::softfloat::f64_eq_bits(a.to_bits(), b.to_bits())
}

fn cmp_f64_ne(a: f64, b: f64) -> bool {
    wasmi_core::softfloat::f64_ne_bits(a.to_bits(), b.to_bits())
}

fn cmp_f64_lt(a: f64, b: f64) -> bool {
    wasmi_core::softfloat::f64_lt_bits(a.to_bits(), b.to_bits())
}

fn cmp_f64_le(a: f64, b: f64) -> bool {
    wasmi_core::softfloat::f64_le_bits(a.to_bits(), b.to_bits())
}

fn cmp_f64_not_lt(a: f64, b: f64) -> bool {
    !cmp_f64_lt(a, b)
}

fn cmp_f64_not_le(a: f64, b: f64) -> bool {
    !cmp_f64_le(a, b)
}
...
impl_execute_branch_binop! {
    ...
    (f32, Op::BranchF32Eq, execute_branch_f32_eq, cmp_f32_eq),
    (f32, Op::BranchF32Ne, execute_branch_f32_ne, cmp_f32_ne),
    (f32, Op::BranchF32Lt, execute_branch_f32_lt, cmp_f32_lt),
    (f32, Op::BranchF32Le, execute_branch_f32_le, cmp_f32_le),
    (f32, Op::BranchF32NotLt, execute_branch_f32_not_lt, cmp_f32_not_lt),
    (f32, Op::BranchF32NotLe, execute_branch_f32_not_le, cmp_f32_not_le),

    (f64, Op::BranchF64Eq, execute_branch_f64_eq, cmp_f64_eq),
    (f64, Op::BranchF64Ne, execute_branch_f64_ne, cmp_f64_ne),
    (f64, Op::BranchF64Lt, execute_branch_f64_lt, cmp_f64_lt),
    (f64, Op::BranchF64Le, execute_branch_f64_le, cmp_f64_le),
    (f64, Op::BranchF64NotLt, execute_branch_f64_not_lt, cmp_f64_not_lt),
    (f64, Op::BranchF64NotLe, execute_branch_f64_not_le, cmp_f64_not_le),
}
...
impl Executor<'_> {
    ...
    pub fn execute_branch_cmp_fallback(&mut self, lhs: Slot, rhs: Slot, params: Slot) {
        ...
        match params.cmp {
            ...
            C::F32Eq => self.execute_branch_binop::<f32>(lhs, rhs, offset, cmp_f32_eq),
            C::F32Ne => self.execute_branch_binop::<f32>(lhs, rhs, offset, cmp_f32_ne),
            C::F32Lt => self.execute_branch_binop::<f32>(lhs, rhs, offset, cmp_f32_lt),
            C::F32Le => self.execute_branch_binop::<f32>(lhs, rhs, offset, cmp_f32_le),
            C::F32NotLt => self.execute_branch_binop::<f32>(lhs, rhs, offset, cmp_f32_not_lt),
            C::F32NotLe => self.execute_branch_binop::<f32>(lhs, rhs, offset, cmp_f32_not_le),
            C::F64Eq => self.execute_branch_binop::<f64>(lhs, rhs, offset, cmp_f64_eq),
            C::F64Ne => self.execute_branch_binop::<f64>(lhs, rhs, offset, cmp_f64_ne),
            C::F64Lt => self.execute_branch_binop::<f64>(lhs, rhs, offset, cmp_f64_lt),
            C::F64Le => self.execute_branch_binop::<f64>(lhs, rhs, offset, cmp_f64_le),
            C::F64NotLt => self.execute_branch_binop::<f64>(lhs, rhs, offset, cmp_f64_not_lt),
            C::F64NotLe => self.execute_branch_binop::<f64>(lhs, rhs, offset, cmp_f64_not_le),
        };
    }
}
