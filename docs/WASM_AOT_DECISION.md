...
position is now `c810-s2-simd-engine-implemented-pre-containment`. The separately
...
C8.10-S2 implements only an acceptance candidate and does not authorize AOT.
