...
zero single-hart contention delta. Physical secondary execution is still reported as gated until
M5.5, and no timing value appears in the golden. A pre-M5.5 `-smp 4` smoke did not
