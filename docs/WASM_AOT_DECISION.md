...
position is now `c811-s1-simd-executable-design-frozen-pre-implementation`. The separately
...
`c811-s1-simd-executable-design-frozen-pre-implementation`; C8.11-S1 freezes
