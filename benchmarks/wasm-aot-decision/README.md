...
`c811-s2-simd-executable-implemented-pre-fixed-qemu`, which does not rewrite this
historical decision.
...
`c811-s2-simd-executable-implemented-pre-fixed-qemu`; C8.11-S2 implements the
new SIMD successor but does not authorize AOT.
