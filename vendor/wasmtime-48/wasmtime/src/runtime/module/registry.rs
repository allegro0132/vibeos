...
#[cfg(not(feature = "custom-code-registry"))]
...
#[cfg(not(feature = "custom-code-registry"))]
pub use default_registry::{lookup_code, register_code, unregister_code};
#[cfg(feature = "custom-code-registry")]
#[path = "custom_registry.rs"]
mod custom_registry;
#[cfg(feature = "custom-code-registry")]
pub use custom_registry::{lookup_code, register_code, unregister_code};
