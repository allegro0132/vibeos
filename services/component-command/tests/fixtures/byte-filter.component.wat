(component
  (core module $guest
    ...
    ;; Bounded input allocations start above the fixed output regions.
    ...
    ;; Canonical ABI for `run(input: list<u8>) -> list<u8>`. The two-field
    ;; result is returned indirectly at 512; transformed bytes live at 4096.
