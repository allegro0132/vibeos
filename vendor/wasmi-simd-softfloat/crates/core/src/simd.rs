...
fn pmin_f32(lhs: f32, rhs: f32) -> f32 {
    if wasm::f32_lt(rhs, lhs) {
        rhs
    } else {
        lhs
    }
...
fn pmin_f64(lhs: f64, rhs: f64) -> f64 {
    if wasm::f64_lt(rhs, lhs) {
        rhs
    } else {
        lhs
    }
...
fn pmax_f32(lhs: f32, rhs: f32) -> f32 {
    if wasm::f32_lt(lhs, rhs) {
        rhs
    } else {
        lhs
    }
...
fn pmax_f64(lhs: f64, rhs: f64) -> f64 {
    if wasm::f64_lt(lhs, rhs) {
        rhs
    } else {
        lhs
    }
...
impl_binary_for! {
    ...
    fn f32x4_pmin(lhs: V128, rhs: V128) -> V128 = pmin_f32;
    fn f64x2_pmin(lhs: V128, rhs: V128) -> V128 = pmin_f64;
    fn f32x4_pmax(lhs: V128, rhs: V128) -> V128 = pmax_f32;
    fn f64x2_pmax(lhs: V128, rhs: V128) -> V128 = pmax_f64;
...
impl_unary_for! {
    ...
    fn f32x4_neg(v128: V128) -> V128 = wasm::f32_neg;
    fn f64x2_neg(v128: V128) -> V128 = wasm::f64_neg;
    fn f32x4_abs(v128: V128) -> V128 = wasm::f32_abs;
    fn f64x2_abs(v128: V128) -> V128 = wasm::f64_abs;
...
impl_comparison_for! {
    ...
    fn f32x4_eq(lhs: V128, rhs: V128) -> V128 = wasm::f32_eq;
    fn f64x2_eq(lhs: V128, rhs: V128) -> V128 = wasm::f64_eq;
    ...
    fn f32x4_ne(lhs: V128, rhs: V128) -> V128 = wasm::f32_ne;
    fn f64x2_ne(lhs: V128, rhs: V128) -> V128 = wasm::f64_ne;
    ...
    fn f32x4_lt(lhs: V128, rhs: V128) -> V128 = wasm::f32_lt;
    fn f64x2_lt(lhs: V128, rhs: V128) -> V128 = wasm::f64_lt;
    ...
    fn f32x4_le(lhs: V128, rhs: V128) -> V128 = wasm::f32_le;
    fn f64x2_le(lhs: V128, rhs: V128) -> V128 = wasm::f64_le;
    ...
    fn f32x4_gt(lhs: V128, rhs: V128) -> V128 = wasm::f32_gt;
    fn f64x2_gt(lhs: V128, rhs: V128) -> V128 = wasm::f64_gt;
    ...
    fn f32x4_ge(lhs: V128, rhs: V128) -> V128 = wasm::f32_ge;
    fn f64x2_ge(lhs: V128, rhs: V128) -> V128 = wasm::f64_ge;
}
...
fn relaxed_madd_f32(a: f32, b: f32, c: f32) -> f32 {
    wasm::f32_add(wasm::f32_mul(a, b), c)
}

fn relaxed_nmadd_f32(a: f32, b: f32, c: f32) -> f32 {
    wasm::f32_add(wasm::f32_neg(wasm::f32_mul(a, b)), c)
}

fn relaxed_madd_f64(a: f64, b: f64, c: f64) -> f64 {
    wasm::f64_add(wasm::f64_mul(a, b), c)
}

fn relaxed_nmadd_f64(a: f64, b: f64, c: f64) -> f64 {
...
impl_ternary_for! {
    fn f32x4_relaxed_madd(a: V128, b: V128, c: V128) -> V128 = relaxed_madd_f32;
    fn f32x4_relaxed_nmadd(a: V128, b: V128, c: V128) -> V128 = relaxed_nmadd_f32;
    fn f64x2_relaxed_madd(a: V128, b: V128, c: V128) -> V128 = relaxed_madd_f64;
    fn f64x2_relaxed_nmadd(a: V128, b: V128, c: V128) -> V128 = relaxed_nmadd_f64;
}
