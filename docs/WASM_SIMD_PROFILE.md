...
Status: `c810-s2-simd-engine-implemented-pre-containment`.
...
ready, and supplies no current engine. Component containment and fixed corpora
remain C8.10-S3 work.
