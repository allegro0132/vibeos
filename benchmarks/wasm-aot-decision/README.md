...
`c810-s3-simd-contained-corpora-passed-pre-admission`, which does not rewrite this
historical decision.
...
C8.10-S3 closes only Component containment/corpora and C8.10-S4 is next.
