...
position is now `c810-s1-simd-design-frozen-pre-implementation`. The separately
...
C8.10-S1 only freezes a validation-only SIMD design and does not authorize AOT.
