(component
  ...
  ;; The sink owns a separately hashed implementation shape. Returning one is
  ;; deliberately unobservable because the selected profile is validation-only.
  ...
  (core module $sink
    ...
    (func (export "callback") (param i32 i32 i32) (result i32)
      i32.const 0))
  (core instance $sink-instance
    (instantiate $sink
      (with "test:c65-validation" (instance $builtins))))
  (alias core export $sink-instance "run" (core func $run))
  (alias core export $sink-instance "callback" (core func $callback))
