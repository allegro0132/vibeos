...
pub use vibeos_runtime_riscv::{
    ...
    local_fence_i, local_sfence_vma, mxr_enabled, probe_extension, probe_extension_raw, reboot, remote_fence_i,
    remote_sfence_vma, send_ipi, set_timer, shutdown, time, wait_for_interrupt,
    pmu_num_counters_raw, pmu_counter_info_raw, pmu_counter_config_raw, pmu_counter_stop_raw, RFENCE_EXTENSION_ID,
};
