...
use crate::{memory, softfloat, Integer, SignExtendFrom, TrapCode};
...
impl_untyped_val! {
    ...
    fn f32_eq(lhs: f32, rhs: f32) -> bool = |lhs: f32, rhs: f32| softfloat::f32_eq_bits(lhs.to_bits(), rhs.to_bits());
    fn f64_eq(lhs: f64, rhs: f64) -> bool = |lhs: f64, rhs: f64| softfloat::f64_eq_bits(lhs.to_bits(), rhs.to_bits());
    fn i32_ne(lhs: i32, rhs: i32) -> bool = op!(!=);
    fn i64_ne(lhs: i64, rhs: i64) -> bool = op!(!=);
    fn f32_ne(lhs: f32, rhs: f32) -> bool = |lhs: f32, rhs: f32| softfloat::f32_ne_bits(lhs.to_bits(), rhs.to_bits());
    fn f64_ne(lhs: f64, rhs: f64) -> bool = |lhs: f64, rhs: f64| softfloat::f64_ne_bits(lhs.to_bits(), rhs.to_bits());
    ...
    fn f32_lt(lhs: f32, rhs: f32) -> bool = |lhs: f32, rhs: f32| softfloat::f32_lt_bits(lhs.to_bits(), rhs.to_bits());
    fn f64_lt(lhs: f64, rhs: f64) -> bool = |lhs: f64, rhs: f64| softfloat::f64_lt_bits(lhs.to_bits(), rhs.to_bits());
    ...
    fn f32_le(lhs: f32, rhs: f32) -> bool = |lhs: f32, rhs: f32| softfloat::f32_le_bits(lhs.to_bits(), rhs.to_bits());
    fn f64_le(lhs: f64, rhs: f64) -> bool = |lhs: f64, rhs: f64| softfloat::f64_le_bits(lhs.to_bits(), rhs.to_bits());
    ...
    fn f32_gt(lhs: f32, rhs: f32) -> bool = |lhs: f32, rhs: f32| softfloat::f32_gt_bits(lhs.to_bits(), rhs.to_bits());
    fn f64_gt(lhs: f64, rhs: f64) -> bool = |lhs: f64, rhs: f64| softfloat::f64_gt_bits(lhs.to_bits(), rhs.to_bits());
    ...
    fn f32_ge(lhs: f32, rhs: f32) -> bool = |lhs: f32, rhs: f32| softfloat::f32_ge_bits(lhs.to_bits(), rhs.to_bits());
    fn f64_ge(lhs: f64, rhs: f64) -> bool = |lhs: f64, rhs: f64| softfloat::f64_ge_bits(lhs.to_bits(), rhs.to_bits());
}

impl_untyped_val! {
    // Wasm Float Instructions

    fn f32_abs(value: f32) -> f32 = |value: f32| f32::from_bits(softfloat::f32_abs_bits(value.to_bits()));
    fn f64_abs(value: f64) -> f64 = |value: f64| f64::from_bits(softfloat::f64_abs_bits(value.to_bits()));
    fn f32_neg(value: f32) -> f32 = |value: f32| f32::from_bits(softfloat::f32_neg_bits(value.to_bits()));
    fn f64_neg(value: f64) -> f64 = |value: f64| f64::from_bits(softfloat::f64_neg_bits(value.to_bits()));
    fn f32_ceil(value: f32) -> f32 = |value: f32| f32::from_bits(softfloat::f32_ceil_bits(value.to_bits()));
    fn f64_ceil(value: f64) -> f64 = |value: f64| f64::from_bits(softfloat::f64_ceil_bits(value.to_bits()));
    fn f32_floor(value: f32) -> f32 = |value: f32| f32::from_bits(softfloat::f32_floor_bits(value.to_bits()));
    fn f64_floor(value: f64) -> f64 = |value: f64| f64::from_bits(softfloat::f64_floor_bits(value.to_bits()));
    fn f32_trunc(value: f32) -> f32 = |value: f32| f32::from_bits(softfloat::f32_trunc_bits(value.to_bits()));
    fn f64_trunc(value: f64) -> f64 = |value: f64| f64::from_bits(softfloat::f64_trunc_bits(value.to_bits()));
    fn f32_nearest(value: f32) -> f32 = |value: f32| f32::from_bits(softfloat::f32_nearest_bits(value.to_bits()));
    fn f64_nearest(value: f64) -> f64 = |value: f64| f64::from_bits(softfloat::f64_nearest_bits(value.to_bits()));
    fn f32_sqrt(value: f32) -> f32 = |value: f32| f32::from_bits(softfloat::f32_sqrt_bits(value.to_bits()));
    fn f64_sqrt(value: f64) -> f64 = |value: f64| f64::from_bits(softfloat::f64_sqrt_bits(value.to_bits()));

    fn f32_add(lhs: f32, rhs: f32) -> f32 = |lhs: f32, rhs: f32| f32::from_bits(softfloat::f32_add_bits(lhs.to_bits(), rhs.to_bits()));
    fn f64_add(lhs: f64, rhs: f64) -> f64 = |lhs: f64, rhs: f64| f64::from_bits(softfloat::f64_add_bits(lhs.to_bits(), rhs.to_bits()));
    fn f32_sub(lhs: f32, rhs: f32) -> f32 = |lhs: f32, rhs: f32| f32::from_bits(softfloat::f32_sub_bits(lhs.to_bits(), rhs.to_bits()));
    fn f64_sub(lhs: f64, rhs: f64) -> f64 = |lhs: f64, rhs: f64| f64::from_bits(softfloat::f64_sub_bits(lhs.to_bits(), rhs.to_bits()));
    fn f32_mul(lhs: f32, rhs: f32) -> f32 = |lhs: f32, rhs: f32| f32::from_bits(softfloat::f32_mul_bits(lhs.to_bits(), rhs.to_bits()));
    fn f64_mul(lhs: f64, rhs: f64) -> f64 = |lhs: f64, rhs: f64| f64::from_bits(softfloat::f64_mul_bits(lhs.to_bits(), rhs.to_bits()));
    fn f32_div(lhs: f32, rhs: f32) -> f32 = |lhs: f32, rhs: f32| f32::from_bits(softfloat::f32_div_bits(lhs.to_bits(), rhs.to_bits()));
    fn f64_div(lhs: f64, rhs: f64) -> f64 = |lhs: f64, rhs: f64| f64::from_bits(softfloat::f64_div_bits(lhs.to_bits(), rhs.to_bits()));
    fn f32_min(lhs: f32, rhs: f32) -> f32 = |lhs: f32, rhs: f32| f32::from_bits(softfloat::f32_min_bits(lhs.to_bits(), rhs.to_bits()));
    fn f64_min(lhs: f64, rhs: f64) -> f64 = |lhs: f64, rhs: f64| f64::from_bits(softfloat::f64_min_bits(lhs.to_bits(), rhs.to_bits()));
    fn f32_max(lhs: f32, rhs: f32) -> f32 = |lhs: f32, rhs: f32| f32::from_bits(softfloat::f32_max_bits(lhs.to_bits(), rhs.to_bits()));
    fn f64_max(lhs: f64, rhs: f64) -> f64 = |lhs: f64, rhs: f64| f64::from_bits(softfloat::f64_max_bits(lhs.to_bits(), rhs.to_bits()));
    fn f32_copysign(lhs: f32, rhs: f32) -> f32 = |lhs: f32, rhs: f32| f32::from_bits(softfloat::f32_copysign_bits(lhs.to_bits(), rhs.to_bits()));
    fn f64_copysign(lhs: f64, rhs: f64) -> f64 = |lhs: f64, rhs: f64| f64::from_bits(softfloat::f64_copysign_bits(lhs.to_bits(), rhs.to_bits()));
}
...
impl_untyped_val! {
    ...
    fn f32_demote_f64(value: f64) -> f32 = |value: f64| f32::from_bits(softfloat::f32_demote_f64_bits(value.to_bits()));
    fn f64_promote_f32(value: f32) -> f64 = |value: f32| f64::from_bits(softfloat::f64_promote_f32_bits(value.to_bits()));

    /// - [`TrapCode::BadConversionToInteger`]: if `value` is NaN
    /// - [`TrapCode::IntegerOverflow`]: if `value` exceeds the bounds of an `i32` value
    fn i32_trunc_f32_s(value: f32) -> Result<i32> = |value: f32| softfloat::i32_trunc_f32_s_bits(value.to_bits());
    /// - [`TrapCode::BadConversionToInteger`]: if `value` is NaN
    /// - [`TrapCode::IntegerOverflow`]: if `value` exceeds the bounds of an `i64` value
    fn i64_trunc_f32_s(value: f32) -> Result<i64> = |value: f32| softfloat::i64_trunc_f32_s_bits(value.to_bits());
    /// - [`TrapCode::BadConversionToInteger`]: if `value` is NaN
    /// - [`TrapCode::IntegerOverflow`]: if `value` exceeds the bounds of an `u32` value
    fn i32_trunc_f32_u(value: f32) -> Result<u32> = |value: f32| softfloat::i32_trunc_f32_u_bits(value.to_bits());
    /// - [`TrapCode::BadConversionToInteger`]: if `value` is NaN
    /// - [`TrapCode::IntegerOverflow`]: if `value` exceeds the bounds of an `u64` value
    fn i64_trunc_f32_u(value: f32) -> Result<u64> = |value: f32| softfloat::i64_trunc_f32_u_bits(value.to_bits());
    /// - [`TrapCode::BadConversionToInteger`]: if `value` is NaN
    /// - [`TrapCode::IntegerOverflow`]: if `value` exceeds the bounds of an `i32` value
    fn i32_trunc_f64_s(value: f64) -> Result<i32> = |value: f64| softfloat::i32_trunc_f64_s_bits(value.to_bits());
    /// - [`TrapCode::BadConversionToInteger`]: if `value` is NaN
    /// - [`TrapCode::IntegerOverflow`]: if `value` exceeds the bounds of an `i64` value
    fn i64_trunc_f64_s(value: f64) -> Result<i64> = |value: f64| softfloat::i64_trunc_f64_s_bits(value.to_bits());
    /// - [`TrapCode::BadConversionToInteger`]: if `value` is NaN
    /// - [`TrapCode::IntegerOverflow`]: if `value` exceeds the bounds of an `u32` value
    fn i32_trunc_f64_u(value: f64) -> Result<u32> = |value: f64| softfloat::i32_trunc_f64_u_bits(value.to_bits());
    /// - [`TrapCode::BadConversionToInteger`]: if `value` is NaN
    /// - [`TrapCode::IntegerOverflow`]: if `value` exceeds the bounds of an `u64` value
    fn i64_trunc_f64_u(value: f64) -> Result<u64> = |value: f64| softfloat::i64_trunc_f64_u_bits(value.to_bits());

    fn f32_convert_i32_s(value: i32) -> f32 = |value| f32::from_bits(softfloat::f32_convert_i32_s_bits(value));
    fn f32_convert_i32_u(value: u32) -> f32 = |value| f32::from_bits(softfloat::f32_convert_i32_u_bits(value));
    fn f32_convert_i64_s(value: i64) -> f32 = |value| f32::from_bits(softfloat::f32_convert_i64_s_bits(value));
    fn f32_convert_i64_u(value: u64) -> f32 = |value| f32::from_bits(softfloat::f32_convert_i64_u_bits(value));
    fn f64_convert_i32_s(value: i32) -> f64 = |value| f64::from_bits(softfloat::f64_convert_i32_s_bits(value));
    fn f64_convert_i32_u(value: u32) -> f64 = |value| f64::from_bits(softfloat::f64_convert_i32_u_bits(value));
    fn f64_convert_i64_s(value: i64) -> f64 = |value| f64::from_bits(softfloat::f64_convert_i64_s_bits(value));
    fn f64_convert_i64_u(value: u64) -> f64 = |value| f64::from_bits(softfloat::f64_convert_i64_u_bits(value));
}
...
impl_untyped_val! {
    ...
    fn i32_trunc_sat_f32_s(value: f32) -> i32 = |value: f32| softfloat::i32_trunc_sat_f32_s_bits(value.to_bits());
    fn i32_trunc_sat_f32_u(value: f32) -> u32 = |value: f32| softfloat::i32_trunc_sat_f32_u_bits(value.to_bits());
    fn i32_trunc_sat_f64_s(value: f64) -> i32 = |value: f64| softfloat::i32_trunc_sat_f64_s_bits(value.to_bits());
    fn i32_trunc_sat_f64_u(value: f64) -> u32 = |value: f64| softfloat::i32_trunc_sat_f64_u_bits(value.to_bits());
    fn i64_trunc_sat_f32_s(value: f32) -> i64 = |value: f32| softfloat::i64_trunc_sat_f32_s_bits(value.to_bits());
    fn i64_trunc_sat_f32_u(value: f32) -> u64 = |value: f32| softfloat::i64_trunc_sat_f32_u_bits(value.to_bits());
    fn i64_trunc_sat_f64_s(value: f64) -> i64 = |value: f64| softfloat::i64_trunc_sat_f64_s_bits(value.to_bits());
    fn i64_trunc_sat_f64_u(value: f64) -> u64 = |value: f64| softfloat::i64_trunc_sat_f64_u_bits(value.to_bits());
}
